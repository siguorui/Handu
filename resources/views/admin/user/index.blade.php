	                      ...
	                      <button class="btn btn-info btn-flat" type="submit">Go!</button>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <a href="{{url('admin/user/edit')}}/{{$v -> id}}" @if(session('adminmaster') -> user_name != $v -> user_name) onclick="javascript:return false;" @endif>修改用户 |</a> <a href="{{url('admin/user/auth')}}/{{$v -> id}}" @if(session('adminmaster') -> auth == 0) onclick="javascript:return false;" @endif> 管理权限 |</a> <a href="{{url('admin/user/delete')}}/{{$v -> id}}" @if(session('adminmaster') -> auth == 0) onclick="javascript:return false;" @endif> 删除</a></td>
                                    @endif
                                </tr> 
                                @endforeach
                                </tfoot>

...
<ul id="brand_cart_1">       
      <li id="rec-6720105">
            ...
            <div class="cbg shop_product_number">
                <span class="amount-widget" id="J_AmountWidget">
                    ...
                    <span class="decrease" onclick="jianshao(this)">-</span>
                     ...
                     <input type="text" onchange="gaibian(this)" name="goods_number" class="text" old="1" value="{{$v['goodsNumber']}}" maxlength="3" title="请输入购买量">
            ...
            <div class="cbg shop_product_close">
                <div class="middle">
                    <a href="javascript:removeToCollect({{$k}},1053493);"> 移入收藏夹</a><br>
...
function delgoods(rec_id){
  ...
  var str='';
  $.post("{{url('/home/goods/deleteCart')}}",{id: rec_id},function(result){

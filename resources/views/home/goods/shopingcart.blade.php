...
$(".cart_good_type").each(function(index,item){
  if(index==0){
    ...
    <a id="btn_goto_checkout" onclick="document.getElementById('formCart').submit();return false"><div class="cart_btn btn1 fr" style="margin-top:12px;position:relative;">
      <div class="turnOrder">
        正在转向订单信息,请稍候！
      </div>
    </div></a>

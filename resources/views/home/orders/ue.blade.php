...
<form name="selectPageForm" action="{{asset('/home/orders/insert')}}/{id}" method="post">
{{csrf_field()}}
 <div id="myOrder">
    <h1 class="theme">
      我的订单评价
    ...
    autoFloatEnabled: true
      ...
      <button style="width:40px;height:30px;" type="submit" class="btn btn-primary" >提交</button>
      </div>
</form>
